                    ...
                    {isLoading ? (
                      ...
                      filtered.map((record) => (
                        <div
                          key={
                            viewMode === "TEAM"
                              ? getReviewRecordId(record as TeamOvertimeRecord)
                              : record.id
                          }
                          ...
                          {viewMode === "TEAM" ? (
                            <div className="flex items-center gap-3">
                              <Avatar className="h-9 w-9 shrink-0">
                                <AvatarImage
                                  src={
                                    (record as TeamOvertimeRecord).user
                                      .avatarUrl
                                  }
                                  alt={(record as TeamOvertimeRecord).user.name}
                                />
                                <AvatarFallback className="text-xs font-semibold bg-primary/10 text-primary">
                                  {getInitials(
                                    (record as TeamOvertimeRecord).user.name,
                                  )}
                                </AvatarFallback>
                              </Avatar>
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <Button
              ...
              disabled={isReviewing}
              variant={
                confirm?.action === "APPROVED" ? "default" : "destructive"
              }
            >
              {isReviewing
                ? "Procesando..."
